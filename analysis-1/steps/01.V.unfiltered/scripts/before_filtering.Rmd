---
title: "Chikv | Statistics and Plots before filtering"
...
Visualize quality control metrics and expression distributions for a single sample before filtering.
Includes summary statistics, highest expressed genes, and cell-level QC plots to guide the
selection of filtering thresholds.
